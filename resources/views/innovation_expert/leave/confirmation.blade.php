...
@section('js')
    <script>
        ...
        jQuery(document).on('click', '.confirm_btn', function (e) {
            ...
            $.ajax({
                url: "{{route('innovation_expert_leave_agreement')}}",
                type: "post",
                // dataType: "json",
                data: {
                    'leave_id': leave_id,
                ...
                success: function (res) {
                    ...
                    window.location.href = "{{route('leave_innovation_expert_confirmation')}}"
                }, error: function (err) {
                    //
                }
            });
        ...
        jQuery(document).on('click', '.un_confirm_btn', function (e) {
            ...
            $.ajax({
                url: "{{route('innovation_expert_leave_disagreement')}}",
                type: "post",
                data: {
                    'leave_id': leave_id,
                },
