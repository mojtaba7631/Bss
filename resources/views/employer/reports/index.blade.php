...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="{{route('employer_report_search_index')}}">
                                        @csrf
                                        <div class="row">
                                            ...
                                            @if($searched)
                                                <div class="col-12 col-sm-6 col-md-3 mb-2">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-12 mb-2">
                                                        <a type="submit" href="{{route('employer_report_index')}}"
                                            ...
                                            <table class="table table-hover table-custom spacing8 text-center">
                                                ...
                                                @foreach($projects as $project)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($project->file_src != '')
                                                                <a href="{{route('employer_report_download_file',['report' => $project->report_id])}}"
    ...
    <div class="modal" id="accept_modal">
        <div class="modal-dialog">
            <form class="modal-content" method="post" action="{{route('employer_report_update')}}">
            @csrf
            <!-- Modal Header -->
