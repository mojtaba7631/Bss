        ...
        <div class="container-fluid">
            <div class="row clearfix">
                    <div class="col-12">
                        <div class="card">
                            <div class="body">
                                <form method="post" action="{{route('employer_project_in_process_search_index')}}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        @if($searched)
                                            <div class="col-12 col-sm-6 col-md-3 mb-2">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-12 mb-2">
                                                    <a type="submit" href="{{route('employer_project_in_process_projects')}}"
                                            ...
                                            <tr>
                                                ...
                                                <td class="position-relative">
                                                    ...
                                                    <a href="{{route('employer_project_view', ['project' => $project->project_id])}}"
                                                       class="active_color dis_a" title="مشاهده پروژه">
...
{{--                                                           class="active_color " title="علل عدم تایید پروژه">--}}
