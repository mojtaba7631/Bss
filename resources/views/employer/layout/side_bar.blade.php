        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{route('employer_project_in_process_projects')}}">
                                <span style="position: relative">کارتابل </span>
                                @if($project_count == 0)
                                    <span></span>
                                @else
                                    <span
                        ...
                        <li><a href="{{route('employer_project_completed_projects')}}">لیست کل</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{route('employer_contract_index')}}">
                ...
                <li>
                    <a href="{{route('employer_report_index')}}">
                ...
                <li class="">
                    <a href="{{route('employer_ticket_index')}}">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{route('employer_letter_new')}}">جدید</a>
                        </li>
                        <li>
                            <a href="{{route('employer_letter_sent_index')}}">ارسالی</a>
                        </li>
                        <li>
                            <a href="{{route('employer_letter_delivered_index')}}">دریافتی</a>
                        </li>
                    </ul>
                </li>
                <li class="">
                    <a href="{{route('employer_alert')}}">
