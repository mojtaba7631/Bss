                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">لیست قراردادها</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="{{route('employer_contract_search_index')}}">
                                @csrf
                                <div class="row">
                                    ...
                                    @if($searched)
                                        ...
                                        <div class="col-12 col-sm-6 col-md-2 mb-2">
                                            <a type="submit" href="{{route('employer_contract_index')}}"
                                            ...
                                            <tr>
                                               ...
                                               <span class="{{$project->status_css}}">
                                                ...
                                                <td class="position-relative">
                                                    ...
                                                    <a href="{{route('employer_contract_view',['project' => $project->project_id])}}"
