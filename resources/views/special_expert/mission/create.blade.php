            ...
            <div class="block-header">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12 text-right hidden-xs">
                        <a href="{{route('mission_special_expert_index')}}" class="btn btn-sm btn-danger"
                           title="">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="{{route('mission_special_expert_store')}}" enctype="multipart/form-data"
                              method="post">
                            @csrf
                            <div class="card-body">
                                <div class="container-fluid my_container">
                                    <div class="row">
                                        <div class="col-12 fnt_leave">
                                            ...
                                            سمت {{$job}} در
                                            مرکز {{$center_title}} تقاضای ماموریت <select
                                        ...
                                        <div class="col-12">
                                            <div class="clock fnt_leave mt-5">
                                                <p class="alert alert-info">لطفا تعداد ساعت و روز ماموریت را تعیین
                                                    فرمایید</p>
