                            ...
                            <div class="chatapp_list">
                                <ul class="right_chat list-unstyled mb-0">
                                    @foreach($users as $user)
                                        <li class="offline">
                                            <a href="{{route('super_ticket_index', ['contact_id' => $user['id']])}}">
                            ...
                            <div id="chat_scroll" class="chatapp_body">
                                                ...
                                                @foreach($messages as $message)
                                                    ...
                                                    <li class="{{$dir}} clearfix">
                                                        ...
                                                        @if($message['has_file'] > 0)
                                                            <a href="{{route('super_ticket_download_ticket', ['ticket_id' => $message['ticket_id']])}}"
                                ...
                                @if($contact_id != "")
                                    <div class="chat-message clearfix">
                                        <form
                                            action="{{route("super_ticket_send", ["contact_id" => $contact_id])}}"
