        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="{{route('supervisor_project_completed_search_index')}}">
                                @csrf
                                <div class="row">
                                    ...
                                    @if($searched)
                                        <div class="col-12 col-sm-6 col-md-3 mb-2">
                                            ...
                                            <div class="col-12 mb-2">
                                                <a type="submit" href="{{route('supervisor_allProjects')}}"
                                                ...
                                                <td class="position-relative">
                                                    ...
                                                    <div class="actions_box">
                                                        @if($project->status > 4 and $project->status !=12)
                                                            <a href="{{route('supervisor_contract_signed_minot',['project' => $project->project_id,'fl'=> true])}}"
