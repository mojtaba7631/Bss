...
@section('title',"داشبورد مدیر مالی")
...
@section('js')
    ...
    <script>
        ...
        function select_employer_chart(tag) {
            ...
            if (employer_id) {
                var url = "{{route('maliManager_getBarChart2Data')}}";
                var data = {
                    _token: '{{csrf_token()}}',
                                        ...
                                        <div class="col-12 mt-4" id="chart2Data_company_data">
                                            ...
                                            <p class="clearfix">
                                                ...
                                                <span class="float-right font-weight-bold"
                                                      id="chart2Data_company_total_value"></span>
                                            </p>

                                            <p class="clearfix">
                                                <b class="float-left">تعداد کل پروژه ها:</b>
                                                <span class="float-right font-weight-bold"
                                                      id="chart2Data_company_total_count"></span>
                                            </p>

                                            <p class="clearfix">
                                                <b class="float-left">تسویه شده:</b>
                                                <span class="float-right font-weight-bold"
                                                      id="chart2Data_company_total_payed"></span>
                                            </p>

                                            <p class="clearfix">
                                                <b class="float-left">بدهی:</b>
                                                <span class="float-right font-weight-bold"
                                                      id="chart2Data_company_total_remind"></span>
                                            </p>
                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <ul class="my_under_donut">
                                <li>
                                    <a class="clearfix"
                                       href="{{route('maliManager_colorDonutChartDetail', ['color' => 'green'])}}">
                                ...
                                <li>
                                    <a class="clearfix"
                                       href="{{route('maliManager_colorDonutChartDetail', ['color' => 'yellow'])}}">
                                ...
                                <li>
                                    <a class="clearfix"
                                       href="{{route('maliManager_colorDonutChartDetail', ['color' => 'red'])}}">
