...
@section('js')
    <script>
        ...
        function doSignature(tag) {
            ...
            loader.show();
            var url = "{{route('maliManager_letter_signature')}}";
        ...
        function send_letter(tag) {
            ...
            if (confirm_code.val()) {
                ...
                $(tag).prop('disabled', true);
                loader.show();
                var url = "{{route('maliManager_letter_add')}}";
            ...
            <div class="block-header">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12 text-right hidden-xs">
                        <a href="{{route('maliManager_letter_sent_index')}}" class="add_btn btn btn-sm btn-danger" title=""><i
                                class="fa fa-arrow-right mr-2"></i>
                            بازگشت به نامه های ارسالی
                        </a>

                        <a href="{{route('maliManager_letter_delivered_index')}}" class="add_btn btn btn-sm btn-danger" title=""><i
                                class="fa fa-arrow-right mr-2"></i>
