        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="{{route('mainManager_fullPayments_search')}}">
                                @csrf
                                <div class="row">
                                    ...
                                    @if($searched)
                                        ...
                                        <div class="col-12 col-sm-6 col-md-2 mb-2">
                                            <a type="submit" href="{{route('mainManager_fullPayments')}}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($payment->payment_file != '')
                                                        <a href="{{route('mainManager_download_file_payment',['payment' => $payment->payment_id])}}"
                                                ...
                                                <td>
                                                    @if($payment->pa_status == 1 and intval($payment->phase_number) > 0)
                                                        <a href="{{route('mainManager_proceeding',['payment_id' => $payment->payment_id])}}"
                                                ...
                                                <td>
                                                        <a href="{{route('mainManager_payment_command',['payment_id' => $payment->payment_id])}}"
                                                           class="btn btn-info text-small">
                                                            <i class="fa fa-credit-card mr-2"></i>
                                                            دستور پرداخت
                                                        </a>
