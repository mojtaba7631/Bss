    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            ...
            <div class="drp dropdown">
                ...
                <strong>رئیس مرکز گفتمان سازی</strong>
            </div>
        </div>
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                @endif
                <li>
                    <a href="{{route('head_discourse_index')}}">
                        <i class="icon-home"></i>
                        <span>صفحه من</span>
                    </a>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{route('leave_head_discourse_index')}}">
                                <span>لیست مرخصی ها</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_head_discourse_create')}}">
