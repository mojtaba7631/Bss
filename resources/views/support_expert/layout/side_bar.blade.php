    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            ...
            <div class="drp dropdown">
                ...
                <strong>کارشناس پشتیبانی</strong>
            </div>
        </div>
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                @endif
                <li>
                    <a href="{{route('support_expert_index')}}">
                        <i class="icon-home"></i>
                        <span>صفحه من</span>
                    </a>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{route('leave_support_expert_index')}}">
                                <span>لیست مرخصی ها</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_support_expert_create')}}">
