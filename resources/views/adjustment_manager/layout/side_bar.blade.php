    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            ...
            <div class="drp dropdown">
                ...
                <strong>رئیس مرکز نظام سازی</strong>
            </div>
        </div>
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                @endif
                <li>
                    <a href="{{route('adjustment_manager_index')}}">
                        <i class="icon-home"></i>
                        <span>صفحه من</span>
                    </a>
                </li>
                <li>
                    <a href="" class="has-arrow">
                        ...
                        @if(\App\Helpers\GetCountLeave::getCountLeave(25) == 0)
                            <span></span>
                        @else
                    ...
                    <ul>
                        <li>
                            <a href="{{route('leave_adjustment_manager_confirmation')}}">
                                ...
                                @else
                                    <span style="position: absolute;color:white;background: red;width: 20px;height: 20px;border-radius: 50%;text-align: center;font-size:11px;padding: 5px;line-height: 10px">
                                        {{\App\Helpers\GetCountLeave::getCountLeave(25)}}
                            </span>
                                @endif
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_adjustment_manager_index')}}">
                                <span>لیست مرخصی ها</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_adjustment_manager_create')}}">
