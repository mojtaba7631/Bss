                                    ...
                                    <table class="table table-hover table-custom spacing8 text-center">
                                        ...
                                        @foreach($projects as $project)
                                            ...
                                            <tr>
                                                ...
                                                @else
                                                <td>
                                                    <a href="{{route('legal_download_propusal', ['project' => $project->project_id])}}"
                                                ...
                                                @else
                                                    <td class="position-relative">
                                                        ...
                                                        <div class="actions_box">
                                                            ...
                                                            @else
                                                                <a href="#" class="deactive_color dis_a" title="پیام فوری">
                                                                    <i class="fa fa-info-circle dis_i"></i>
                                                                    <span class="span_title">
                                                                    پیام
                                                                    <br>
                                                            ...
                                                            @if($project->status == 2 && $project->confirmed_by_employer == 0 && $project->rejected_by_employer == 0)
                                                                <a href="{{route('legal_contract_add', ['project_id' => $project->project_id])}}"
                                                                   class="active_color dis_a" title="تنظیم فرم قرارداد">
                                                            ...
                                                            @elseif($project->status == 2 && $project->confirmed_by_employer == 1)
                                                                <a href="{{route('legal_contract_edit', ['project_id' => $project->project_id])}}"
                                                            ...
                                                            @else
                                                                <a href="#" class="my_a dis_a" title="تنظیم فرم قرارداد">
                                                                    <i class="fa fa-tasks ml-2 dis_i"></i>
                                                                    <span class="span_title">
                                                                    تنظیم
                                                                    <br>
                                                            ...
                                                            @else
                                                                <a href="#"
                                                                   class="deactive_color dis_a" title="امضا دیجیتال">
                                                                    <i class="fa fa-check-square ml-2 dis_i"></i>
                                                                    <span class="span_title">
                                                                    امضا
                                                                    <br>
                                                            ...
                                                            @endif
                                                            @if($project->status > 3)
                                                                <a href="{{route('legal_contract_view',['project' => $project->project_id])}}"
                                                            ...
                                                            @if($project->status == 12)
                                                                <a href="{{route('legal_project_edit', ['project' => $project->project_id])}}"
                                                            ...
                                                            @else
                                                                @if($project->contract == 0)
                                                                    <a href="#"
                                                                       class="margin_icon my_a dis_a" title="حذف قرارداد">
                                                                        <i class="fa fa-trash dis_i"></i>
                                                                        <span class="span_title">
                                                                        حذف
                                                                        <br>
