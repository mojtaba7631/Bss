...
@section('js')
    ...
    <script>
        ...
        var from_selected_date = {
            day: '{{explode('/', $project_info['start_date_jalali'])[2]}}',
            month: '{{explode('/', $project_info['start_date_jalali'])[1]}}',
            year: '{{explode('/', $project_info['start_date_jalali'])[0]}}',
        };
        var to_selected_date = {
            day: '{{explode('/', $project_info['end_date_jalali'])[2]}}',
            month: '{{explode('/', $project_info['end_date_jalali'])[1]}}',
            year: '{{explode('/', $project_info['end_date_jalali'])[0]}}',
        };
...
@section('content')
    ...
    <input type="hidden" id="route_inp" value="{{route('legal_project_contract_update')}}">
    <input type="hidden" id="return_route_inp" value="{{route('legal_project_in_process')}}">
    <div id="main-content">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-3">
                                            ...
                                            <input id="total_price_inp" oninput="setComma(this, false,false,true)"
                                                   type="text"
                                                   value="{{@number_format($project_info['contract_cost'])}}"
                                        ...
                                        <div class="col-12 col-sm-6 col-md-2">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    id="start_date_show_text">{{$project_info['start_date_jalali']}}</span>
                                                <input value="{{$project_info['start_date_jalali']}}" type="hidden"
                                                       id="start_date_inp">
                                            </div>
                                            <div data-date="{{$project_info['start_date_jalali']}}" data-show="0"
                                                 id="form_date_picker"
                                        ...
                                        <div class="col-12 col-sm-6 col-md-2 position-relative">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    id="end_date_show_text">{{$project_info['end_date_jalali']}}</span>
                                                <input value="{{$project_info['end_date_jalali']}}" type="hidden"
                                                       id="end_date_inp">
                                            </div>
                                            <div data-date="{{$project_info['end_date_jalali']}}" data-show="0"
                                                 id="to_date_picker" class="range-to-example my_dp"></div>
                                        </div>

                                        <div class="col-12 col-sm-6 col-md-2 position-relative">
                                            <label>تعداد کل روزها</label>
                                            <div>
                                                <input value="{{$project_info['day_count']}}" id="total_day_count"
                                                       type="hidden">
                                                <span id="total_days_count_show" class="font-weight-bold">{{$project_info['day_count']}} روز</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div id="comment_errors"
                                                 class="error_validate text-danger"></div>
                                            <textarea id="comment"
                                                      class="summernote">{{$project_info['service_description']}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div id="required_outputs_errors"
                                                 class="error_validate text-danger"></div>
                                            <textarea id="required_outputs"
                                                      class="summernote">{{$project_info['required_outputs']}}</textarea>
                                        </div>
                                    </div>
                                </div>
