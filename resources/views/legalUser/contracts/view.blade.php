            ...
            <div class="block-header">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12 text-right hidden-xs">
                        <a href="{{route('legal_project_in_process')}}" class="btn btn-sm btn-outline-danger"
                           title="">
                                    ...
                                    <div class="row special_border">
                                        ...
                                        <div class="col-12">
                                            ...
                                            @if($supervisor_info != null)
                                                <p class="d-inline-block">{{$supervisor_info}}</p>
                                            @else
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <textarea id="err_message" class="form-control" rows="3"
                              placeholder="لطفا علت عدم تایید را بنویسید"></textarea>
                </div>
