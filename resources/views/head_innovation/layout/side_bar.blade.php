    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            ...
            <div class="drp dropdown">
                ...
                <strong>رئیس مرکز نوآوری</strong>
            </div>
        </div>
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                @endif
                <li>
                    <a href="{{route('head_innovation_index')}}">
                        <i class="icon-home"></i>
                        <span>صفحه من</span>
                    </a>
                </li>
                <li>
                    <a href="" class="has-arrow">
                        ...
                        @if(\App\Helpers\GetCountLeave::getCountLeave(14) == 0)
                            <span></span>
                        @else
                    ...
                    <ul>
                        <li>
                            <a href="{{route('leave_head_innovation_confirmation')}}">
                                ...
                                @else
                                    <span style="position: absolute;color:white;background: red;width: 20px;height: 20px;border-radius: 50%;text-align: center;font-size:11px;padding: 5px;line-height: 10px">
                                        {{\App\Helpers\GetCountLeave::getCountLeave(14)}}
                            </span>
                                @endif
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_head_innovation_index')}}">
                                <span>لیست مرخصی ها</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_head_innovation_create')}}">
