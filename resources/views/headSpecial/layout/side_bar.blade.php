    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            ...
            <div class="drp dropdown">
                ...
                <strong>رییس مرکز عملیات ویژه</strong>
            </div>
        </div>
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                @endif
                <li>
                    <a href="{{route('head_special_operation_center')}}">
                        <i class="icon-home"></i>
                        <span>صفحه من</span>
                    </a>
                </li>
                <li>
                    <a href="" class="has-arrow">
                        ...
                        @if(\App\Helpers\GetCountLeave::getCountLeave(12) == 0)
                            <span></span>
                        @else
                    ...
                    <ul>
                        <li>
                            <a href="{{route('leave_head_special_confirmation')}}">
                                ...
                                @else
                                    <span style="position: absolute;color:white;background: red;width: 20px;height: 20px;border-radius: 50%;text-align: center;font-size:11px;padding: 5px;line-height: 10px">
                                        {{\App\Helpers\GetCountLeave::getCountLeave(12)}}
                            </span>
                                @endif
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_head_special_index')}}">
                                <span>لیست مرخصی ها</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_head_special_create')}}">
