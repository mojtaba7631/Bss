...
@section('js')
    ...
    <script>
        ...
        function select_employer_chart(tag) {
            ...
            if (employer_id) {
                var url = "{{route('admin_getBarChart2Data')}}";
                var data = {
                    _token: '{{csrf_token()}}',
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <ul class="my_under_donut">
                                <li>
                                    <a class="clearfix"
                                       href="{{route('admin_colorDonutChartDetail', ['color' => 'green'])}}">
                                ...
                                <li>
                                    <a class="clearfix"
                                       href="{{route('admin_colorDonutChartDetail', ['color' => 'yellow'])}}">
                                ...
                                <li>
                                    <a class="clearfix"
                                       href="{{route('admin_colorDonutChartDetail', ['color' => 'red'])}}">
