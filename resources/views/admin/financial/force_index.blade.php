        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="{{route('admin_financial_force_index_search')}}">
                                @csrf
                                <div class="row">
                                    ...
                                    @if($searched)
                                        ...
                                        <div class="col-12 col-sm-6 col-md-2 mb-2">
                                            <a type="submit" href="{{route('admin_financial_force_index')}}"
...
{{--                                                <td>--}}
{{--                                                    <a href="{{route('tarhoBarname_financial_force_detail',['project'=>$payment->payment_id])}}"--}}
