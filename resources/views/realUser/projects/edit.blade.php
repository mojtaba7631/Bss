            ...
            <div class="block-header">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12 text-right hidden-xs">
                        <a href="{{route('real_project_in_process')}}" class="btn btn-sm btn-danger">
            ...
            <div class="container">
                <div class="row clearfix">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{route('real_project_update',['project'=> $project->id])}}"
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="employer" class="form-select form-control " name="employer"
                                                ...
                                                @foreach($employer_users as $employer_user)
                                                    <option
                                                        {{ $project->employer_id == $employer_user->user_id ? 'selected' : '' }} value="{{$employer_user->user_id}}">
                                        ...
                                        <div class="card card_bottom">
                                            ...
                                            @if(!is_null($project->file))
                                                <a href="{{asset($project->file)}}" class="btn btn-warning w-100 mt-2">دانلود
                                                    فایل پروپوزال</a>
                                            @endif
                                        </div>
                                    </div>
