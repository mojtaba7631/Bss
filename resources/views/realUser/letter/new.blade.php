...
@section('js')
    <script>
        ...
        function doSignature(tag) {
            ...
            loader.show();
            var url = "{{route('real_letter_signature')}}";
            ...
            <div class="block-header">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12 text-right hidden-xs">
                        <a href="{{route('real_letter_sent_index')}}" class="add_btn btn btn-sm btn-danger" title=""><i
                                class="fa fa-arrow-right mr-2"></i>
                            بازگشت به نامه های ارسالی
                        </a>

                        <a href="{{route('real_letter_delivered_index')}}" class="add_btn btn btn-sm btn-danger" title=""><i
                                class="fa fa-arrow-right mr-2"></i>
