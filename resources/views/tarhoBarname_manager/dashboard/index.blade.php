...
@section('title',"داشبورد مدیر طرح و برنامه")
...
@section('js')
    ...
    <script>
        ...
        function select_employer_chart(tag) {
            ...
            if (employer_id) {
                var url = "{{route('tarho_Barname_getBarChart2Data')}}";
                var data = {
                    _token: '{{csrf_token()}}',
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <ul class="my_under_donut">
                                <li>
                                    <a class="clearfix"
                                       href="{{route('tarho_Barname_manager_colorDonutChartDetail', ['color' => 'green'])}}">
                                ...
                                <li>
                                    <a class="clearfix"
                                       href="{{route('tarho_Barname_manager_colorDonutChartDetail', ['color' => 'yellow'])}}">
                                ...
                                <li>
                                    <a class="clearfix"
                                       href="{{route('tarho_Barname_manager_colorDonutChartDetail', ['color' => 'red'])}}">
