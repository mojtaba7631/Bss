            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1>جدول پرداخت فوری</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">نما</a></li>
                                <li class="breadcrumb-item active" aria-current="page">جدول پرداخت فوری</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-12">
                    <div class="card">
                        <div class="body">
                            <form method="post" action="{{route('tarhoBarname_financial_force_index_search')}}">
                                @csrf
                                <div class="row">
                                    ...
                                    @if($searched)
                                        ...
                                        <div class="col-12 col-sm-6 col-md-2 mb-2">
                                            <a type="submit" href="{{route('tarhoBarname_financial_force_index')}}"
                                        ...
                                        <table class="table table-hover table-custom spacing8 text-center">
                                            ...
                                            @foreach($projectsGroupByProject as $project)
                                                ...
                                                <span class="project_unique_code">
                                                    ...
                                                    <td>
                                                        <a href="{{route('tarhoBarname_financial_force_detail',['project'=>$project['project_id']])}}">
