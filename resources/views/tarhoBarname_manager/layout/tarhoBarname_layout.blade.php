...
@include('sweet::alert')
@include('tarhoBarname_manager.layout.page_loader')
@include('tarhoBarname_manager.layout.top_navbar')
{{--@include('tarhoBarname_manager.layout.rightbar')--}}
@include('tarhoBarname_manager.layout.side_bar')
@yield('content')
