        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                        ...
                        <ul>
                            @foreach($roles as $role)
                                @if($role['route_title'] == 'personnel_index')
                                    <li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{route('leave_personnel_index')}}">
                                <span>لیست مرخصی ها</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('leave_personnel_create')}}">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{route('mission_personnel_index')}}">
                                <span>لیست ماموریت ها</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('mission_personnel_create')}}">
