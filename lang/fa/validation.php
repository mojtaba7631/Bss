...
return [
    ...
    'attributes' => [
        ...
        'national_code_img'        =>'عکس کارت ملی',
        'co_name'        =>'نام شرکت',
        'co_reg_number'        =>'شماره ثبت',
        'co_national_id'        =>'شناسه ملی',
        'co_reg_date'        =>'تاریخ ثبت شرکت',
        'co_statute_image'        =>'اساسنامه',
        'subject'        =>'موضوع',
        'file'        =>'فایل',
        'file_src' => 'فایل گزارش',
        'unique_code' => 'کداختصاصی',
        'Signature_img' => 'تصویر امضا',
        'stamp_img' => 'تصویر مهر',
        'sayyad_code_val' => 'کد صیاد',
        'check_code_val' => 'کد پیگیری',
