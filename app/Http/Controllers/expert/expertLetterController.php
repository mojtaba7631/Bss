...
class expertLetterController extends Controller
{
    function index(){
    ...
    function sent_index()
    {
        ...
        return view('expert.letter.index', compact('letters'));
    }
    ...
    function delivered_index()
    {
        ...
        return view('expert.letter.delivered', compact('letters'));
    }
    ...
    function new()
    {
        ...
        return view('expert.letter.new', compact('contacts'));
    }
    ...
    function preview($letter_id)
    {
        ...
        return view('expert.letter.letter_preview', compact('letter_info'));
    }
