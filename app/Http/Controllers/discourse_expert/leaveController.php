...
namespace App\Http\Controllers\discourse_expert;
...
class leaveController extends Controller
{
    public function index(){
        ...
        $searched = false;
        return view('discourse_expert.leave.index', compact('user_img', 'user_info', 'leaves', 'searched'));
    ...
    public function Confirmation()
    {
        ...
        return view('discourse_expert.leave.confirmation', compact('user_img', 'user_info', 'leaves', 'searched'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leave_discourse_expert_index');
    }
