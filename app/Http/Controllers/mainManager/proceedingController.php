...
class proceedingController extends Controller
{
    function index($payment_id)
    {
        ...
        return view('main_manager.proceeding.proceeding', compact('project_info', 'phase_info', 'report_info', 'supervisor_info', 'user_name', 'payment_info', 'employer_info', 'main_manager'));
    }
}
