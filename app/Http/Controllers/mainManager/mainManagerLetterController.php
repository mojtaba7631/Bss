...
class mainManagerLetterController extends Controller
{
    function sent_index()
    {
        ...
        return view('main_manager.letter.index', compact('letters'));
    }
    ...
    function delivered_index()
    {
        ...
        return view('main_manager.letter.delivered', compact('letters'));
    }
    ...
    function new()
    {
        ...
        return view('main_manager.letter.new', compact('contacts'));
    }
        ...
        if ($letter_info) {
            if ($letter_info['confirm_code'] == $code) {
                ...
                return response()->json([
                    ...
                    'location' => route('mainManager_letter_preview', ['letter_id' => $letter_id]),
                ]);
            } else {
                return response()->json([
                    'error' => true,
    ...
    function preview($letter_id)
    {
        ...
        return view('main_manager.letter.letter_preview', compact('letter_info'));
    }
    ...
    function final_submit($letter_id)
    {
        ...
        return redirect()->route('mainManager_letter_sent_index');
    }
}
