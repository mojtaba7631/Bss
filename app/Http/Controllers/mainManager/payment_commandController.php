...
class payment_commandController extends Controller
{
    public function index($payment_id)
    {
        ...
        return view('main_manager.payment_command.payment_command', compact('project_info', 'phase_info', 'report_info', 'supervisor_info', 'user_name', 'payment_info', 'employer_info', 'main_manager','mali_manager'));
    }
}
