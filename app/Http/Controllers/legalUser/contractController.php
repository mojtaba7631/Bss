...
class contractController extends Controller
{
    public function add($project_id)
    {
        ...
        return view('legalUser.contracts.add', compact('project_id', 'project_info'));
    }
    ...
    public function edit($project)
    {
        ...
        return view('legalUser.contracts.edit', compact('project', 'project_id', 'project_info', 'phases_info'));
    }
...
//        }
    ...
    public function verify_sign(Project $project, Request $request)
    {
        ...
        if ($txt_sign == $project->sign_code) {
            ...
            return response()->json([
                ...
                'location' => route('legal_project_in_process'),
    ...
    public function contract_edit(Project $project)
    {
        dd($project);
        return view('legalUser.projects.contract_edit');
    }
    ...
    function view(Project $project)
    {
        ...
        return view('legalUser.contracts.view', ['supervisor_info' => $supervisor_info, 'user_img' => $user_img, 'supervisor' => $supervisor, 'users' => $users, 'phase' => $phase, 'phases' => $phases, 'project' => $project, 'project_start_date_jalali' => $project_start_date_jalali, 'project_end_date_jalali' => $project_end_date_jalali]);
    }
}
