...
class LetterController extends Controller
{
    ...
    function delivered_index()
    {
        ...
        return view('admin.letter.delivered', compact('letters'));
    }
    ...
    function new()
    {
        ...
        return view('admin.letter.new', compact('contacts'));
    }
        ...
        if ($letter_info) {
            if ($letter_info['confirm_code'] == $code) {
                ...
                return response()->json([
                    ...
                    'location' => route('admin_letter_preview', ['letter_id' => $letter_id]),
                ]);
            } else {
                return response()->json([
                    'error' => true,
    ...
    function preview($letter_id)
    {
        ...
        return view('admin.letter.letter_preview', compact('letter_info'));
    }
    ...
    function final_submit($letter_id)
    {
        ...
        return redirect()->route('admin_letter_sent_index');
    }
}
