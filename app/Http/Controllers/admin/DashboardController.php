...
class DashboardController extends Controller
{
    function index()
    {
        ...
        return view('admin.dashboard.index', compact("chart_employers", "weekly", "color_chart_data", "user_info", "employer_projects", "employers", "total_opened_project_count", "total_opened_project_sum", "total_promise_sum", "total_have_to_pay_sum", "total_all_payed_sum", "color_chart_data"));
    }
