...
namespace App\Http\Controllers\head_innovation;
...
class leaveController extends Controller
{
    public function index(){
        ...
        $searched = false;
        return view('head_innovation.leave.index', compact('user_img', 'user_info', 'leaves', 'searched'));
    ...
    public function Confirmation()
    {
        ...
        return view('head_innovation.leave.confirmation', compact('user_img', 'user_info', 'leaves', 'searched'));
    }
    ...
    public function create()
    {
        ...
        $user_info = User::query()
            ->where('id', $user_id)
            ->first();
        $role_title = 'رئیس مرکز نوآوری';
        $user_img = $user_info->image;
        return view('head_innovation.leave.create', compact('user_img', 'user_info','role_title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leave_head_innovation_index');
    }
