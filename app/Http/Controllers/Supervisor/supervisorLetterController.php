...
class supervisorLetterController extends Controller
{
    function sent_index()
    {
        ...
        return view('supervisor.letter.index', compact('letters'));
    }
    ...
    function delivered_index()
    {
        ...
        return view('supervisor.letter.delivered', compact('letters'));
    }
    ...
    function new()
    {
        ...
        return view('supervisor.letter.new', compact('contacts'));
    }
        ...
        if ($letter_info) {
            if ($letter_info['confirm_code'] == $code) {
                ...
                return response()->json([
                    ...
                    'location' => route('supervisor_letter_preview', ['letter_id' => $letter_id]),
                ]);
            } else {
                return response()->json([
                    'error' => true,
    ...
    function preview($letter_id)
    {
        ...
        return view('supervisor.letter.letter_preview', compact('letter_info'));
    }
    ...
    function final_submit($letter_id)
    {
        ...
        return redirect()->route('supervisor_letter_sent_index');
    }
}
