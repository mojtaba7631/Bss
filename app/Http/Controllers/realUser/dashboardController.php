...
class dashboardController extends Controller
{
    function index()
    {
        ...
        foreach ($projects as $project) {
            ...
            if ($project->status == 8) {
                ...
                if ($project->status == 8 || $project->status == 9 || $project->status == 10 || $project->status == 2) {
                     if (isset($circleChart[$result[0]]) and isset($circleChart[$project['s_title']])) {
        ...
        return view('realUser.dashboard.index', compact("monthly_price_chart", "user_info", "projects", "getDataForChart", "total_opened_project_count", "total_opened_project_sum", "total_closed_project_count", "total_closed_project_sum"));
    }
    ...
    function profile()
    {
        ...
        return view('realUser.profile.index', compact('user_info'));
    }

    function download_propusal($project){
