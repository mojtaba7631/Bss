...
class realUserLetterController extends Controller
{
    function sent_index()
    {
        ...
        return view('realUser.letter.index', compact('letters'));
    }
    ...
    function delivered_index()
    {
        ...
        return view('realUser.letter.delivered', compact('letters'));
    }
    ...
    function new()
    {
        ...
        return view('realUser.letter.new', compact('contacts'));
    }
        ...
        if ($letter_info) {
            if ($letter_info['confirm_code'] == $code) {
                ...
                return response()->json([
                    ...
                    'location' => route('realUser_letter_preview', ['letter_id' => $letter_id]),
                ]);
            } else {
                return response()->json([
                    'error' => true,
    ...
    function preview($letter_id)
    {
        ...
        return view('realUser.letter.letter_preview', compact('letter_info'));
    }
    ...
    function final_submit($letter_id)
    {
        ...
        return redirect()->route('realUser_letter_sent_index');
    }
}
