...
class projectController extends Controller
{
    public function index()
    {
        ...
        return view('realUser.projects.index', ['projects' => $projects, 'employers' => $employers, 'projects_status' => $projects_status, 'phases_status' => $phases_status, 'searched' => $searched]);
    }
    ...
    public function add()
    {
        ...
        return view('realUser.projects.add', compact("employers"));
    }
    ...
    public function create(Request $request)
    {
        ...
        $employer_mobile = $employer_info->mobile;
        ...
        return redirect()->route('real_project_in_process');
    }
    ...
    public function edit(Project $project)
    {
        ...
        return view('realUser.projects.edit', compact("project", "employer_users"));
    }
    ...
    public function completed_projects()
    {
        ...
        return view('realUser.projects.completed_projects', ['projects' => $projects, 'employers' => $employers, 'projects_status' => $projects_status, 'phases_status' => $phases_status, 'searched' => $searched]);
    }
    ...
    public function error_message(Project $project)
    {
        ...
        return View('realUser.projects.error_page', ['project' => $project, 'error_messages' => $error_messages]);
    }
