...
class leaveController extends Controller
{
    public function index(){
        ...
        $searched = false;
        return view('adjustment_manager.leave.index', compact('user_img', 'user_info', 'leaves', 'searched'));
    ...
    public function Confirmation()
    {
        ...
        return view('adjustment_manager.leave.confirmation', compact('user_img', 'user_info', 'leaves', 'searched'));
    }
    ...
    public function create()
    {
        ...
        $user_info = User::query()
            ->where('id', $user_id)
            ->first();
        $role_title = 'رئیس مرکز نظام سازی';
        $center_title = 'نظام سازی';
        $user_img = $user_info->image;
        return view('adjustment_manager.leave.create', compact('user_img', 'user_info','role_title','center_title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leave_adjustment_manager_index');
    }
