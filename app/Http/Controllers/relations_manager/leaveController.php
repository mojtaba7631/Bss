...
class leaveController extends Controller
{
    public function index(){
        ...
        $searched = false;
        return view('relations_manager.leave.index', compact('user_img', 'user_info', 'leaves', 'searched'));
    ...
    public function Confirmation()
    {
        ...
        return view('relations_manager.leave.confirmation', compact('user_img', 'user_info', 'leaves', 'searched'));
    }
    ...
    public function create()
    {
        ...
        $user_info = User::query()
            ->where('id', $user_id)
            ->first();
        $role_title = 'مدیر روابط عمومی';
        $user_img = $user_info->image;
        return view('relations_manager.leave.create', compact('user_img', 'user_info','role_title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leave_relations_manager_index');
    }
