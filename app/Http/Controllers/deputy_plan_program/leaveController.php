...
class leaveController extends Controller
{
    public function index(){
        ...
        $searched = false;
        return view('deputy_plan_program.leave.index', compact('user_img', 'user_info', 'leaves', 'searched'));
    ...
    public function create()
    {
        ...
        $user_img = $user_info->image;
        return view('deputy_plan_program.leave.create', compact('user_img', 'user_info'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leave_deputy_index');
    }
