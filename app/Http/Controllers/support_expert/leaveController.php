...
class leaveController extends Controller
{
    public function index(){
        ...
        $searched = false;
        return view('support_expert.leave.index', compact('user_img', 'user_info', 'leaves', 'searched'));
    ...
    public function Confirmation()
    {
        ...
        return view('support_expert.leave.confirmation', compact('user_img', 'user_info', 'leaves', 'searched'));
    }
    ...
    public function create()
    {
        ...
        $user_info = User::query()
            ->where('id', $user_id)
            ->first();
        $role_title = 'کارشناس پشتیانی';
        $user_img = $user_info->image;
        return view('support_expert.leave.create', compact('user_img', 'user_info','role_title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leave_support_expert_index');
    }
