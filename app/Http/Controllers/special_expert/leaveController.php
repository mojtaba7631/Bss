...
class leaveController extends Controller
{
    public function index(){
        ...
        $searched = false;
        return view('special_expert.leave.index', compact('user_img', 'user_info', 'leaves', 'searched'));
    ...
    public function Confirmation()
    {
        ...
        return view('special_expert.leave.confirmation', compact('user_img', 'user_info', 'leaves', 'searched'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leave_special_expert_index');
    }
